...
if __name__ == '__main__':
    ...
    # Printing
    print("#" * 40)
    printTitle("Released and Versioned RHCOS Artifacts")
    ...
    for v in va.get_versions():
        ...
        for sv in va.get_subversions_from_version(v):
            ...
            for a in va.get_artifacts_from_version_and_subversion(v, sv):
                print("    - " + a)
    print("#" * 40)
    printTitle("Latest Released RHCOS Artifacts")
    la = ra.get_latest_artifacts()
    for i in la:
        print("  - " + i)
    print("#" * 40)
    printTitle("Pre Release and Sub versioned RHCOS Artifacts")
